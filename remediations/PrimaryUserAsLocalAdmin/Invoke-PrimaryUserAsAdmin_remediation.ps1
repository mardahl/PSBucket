...
$tenant = "xxxxx.onmicrosoft.com" #onmicrosoft.com name
$clientId = "xxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxx" #App API premissions on Graph API as Application should be DeviceManagementManagedDevices.Read.All and GroupMember.Read.All and user.readBasic.All
$clientSecret = "xixxxxxxxxxxxxxxxxEDckY"
...
$allowedAdminsAADGroupID = "xxxxxxxxxx-xxxx-xxxxx-xxxx-xxxxxxxxx" #Object ID of group that lists who is allowed to be local admins on their primary devices. MUST NOT BE THE SAME GROUP AS REMEDIATIONS ARE TARGETED!
